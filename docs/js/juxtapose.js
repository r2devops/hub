    ...
    JXSlider.prototype = {
        ...
        _init: function() {
            ...
            this.slider.addEventListener("mousedown", function(e) {
                ...
                imageX = boudingRect.x
                imageWidth = imageX + boudingRect.width;
                mouseMove = function(e) {
                    e = e || window.event;
                    e.preventDefault();
                    if (animate) { self.updateSlider(e, false); }
                    if (e.clientX - imageX <= 0 && e.clientX <= imageX) 
                        self.updateSlider(0, false);
                    else if (e.clientX > imageWidth && e.clientX <= window.innerWidth)
                        self.updateSlider(100, false);
                };
